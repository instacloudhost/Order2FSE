...
public class SellerListModel {
    ...
    public SellerListModel(String orderId, String orderDateTime, String orderValue, String orderValueText, String sellerName, String sellerMobile, String sellerStatus) {

...
public class SubCategoryMedium {
    ...
    @Expose
    private SubCustomProperties customProperties;
    ...
    public SubCustomProperties getCustomProperties() {
        return customProperties;
    }

    public void setCustomProperties(SubCustomProperties customProperties) {
